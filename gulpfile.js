...
var paths = {
  ...
  material_kit:['dev/css/**/**/material-kit.scss'],
  js:['dev/js/**/**/*.js'],
  img:['dev/img/**/**/*'],
...
gulp.task("material_kit", function () {
    gulp.src(paths.material_kit)
    .pipe(scss().on( 'error', notify.onError(
      {
        message: "<%= error.message %>",
        title  : "material_kit Error!"
      } ) )
...
gulp.task('watcher',function(){
  ...
  gulp.watch(paths.material_kit, ['material_kit']);
});
